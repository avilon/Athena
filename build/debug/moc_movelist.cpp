...
const QMetaObject MoveList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MoveList.data,
      qt_meta_data_MoveList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MoveList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MoveList.stringdata0))
        return static_cast<void*>(const_cast< MoveList*>(this));
