...
QT_MOC_LITERAL(1, 6, 12), // "onChangeSize"
...
QT_MOC_LITERAL(5, 44, 9) // "changeLaw"
    ...
    "Board\0onChangeSize\0\0boardSize\0"
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onChangeSize((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (Board::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::onChangeSize)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Board::onChangeSize(int _t1, int _t2)
{
